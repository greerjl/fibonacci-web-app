# Platform Engineering Interview Project

Hi there! Thanks so much for participating in our interview process. Your mission--should you choose to accept it--is to write a web application that generates Fibonacci numbers based on user input.  The idea is that you build a production-ready application that kvwill be maintained for the next several years, and can run on a multitude of cloud environments.
